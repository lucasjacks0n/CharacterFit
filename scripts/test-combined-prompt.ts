...
import { buildPrompt, combinedContentPrompt } from '../src/prompts/outfitContentSections';
...
const testVariables = {
  ...
  list_of_costume_items: 'black hat, long black trench coat, black gloves, black boots, wrestling tights',
  moondream_description: 'A tall, imposing figure dressed entirely in black with a wide-brimmed hat casting shadows over his face',
};
...
console.log(JSON.stringify({
  mainDescription: '3-6 sentences describing the costume...',
